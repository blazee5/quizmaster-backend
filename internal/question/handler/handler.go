...
func (h *Handler) GetQuestionsAuthor(c echo.Context) error {
	ctx, span := h.tracer.Start(c.Request().Context(), "question.GetQuestionsAuthor")
	defer span.End()
	...
	questions, err := h.service.GetQuestionsAuthor(ctx, quizID, userID)
