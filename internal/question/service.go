...
type Service interface {
	...
	GetQuestionsAuthor(ctx context.Context, quizID, userID int) ([]models.QuestionWithAnswers, error)
	...
	ChangeOrder(ctx context.Context, userId, quizId int, input domain.QuestionOrder) error
}
