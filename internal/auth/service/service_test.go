...
func TestSignUp(t *testing.T) {
	...
	authService := NewService(log, mockAuthRepo)

	mockAuthRepo.EXPECT().CreateUser(ctx, gomock.Eq(domain.SignUpRequest{
		Username: "username",
		Email:    "email@gmail.com",
...
func TestSignIn(t *testing.T) {
	...
	mockAuthRepo.EXPECT().ValidateUser(ctx, gomock.Eq(domain.SignInRequest{
		Email:    "email@gmail.com",
		Password: auth.GenerateHashPassword(user.Password),
